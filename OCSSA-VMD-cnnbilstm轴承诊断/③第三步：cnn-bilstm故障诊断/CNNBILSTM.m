...
layers0 = [ ...
    ...
    convolution2dLayer([32,1],10,'Stride',[1,1],'name','conv1')  %添加卷积层，64，1表示过滤器大小，10过滤器个数，Stride是垂直和水平过滤的步长
    ...
    bilstmLayer(35,'Outputmode','last','name','hidden1') 
...
ylabel('Real label')
title(['CNN-bilstm的测试集正确率 = ',num2str(accuracy*100),' %'])
% 作图
figure
